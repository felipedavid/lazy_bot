...
cl /LD /Zi /Fe..\bin\lazy_bot.dll -DSOKOL_GLCORE33 main.c gui.c signal_event_manager.c state.c bot.c local_player.c objects.c utils.c hacks.c memory_manager.c game_functions.c sync_thread.c user32.lib dxguid.lib d3d11.lib gdi32.lib /link /incremental:no
