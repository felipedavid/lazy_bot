...
typedef void *(__fastcall *FnClntObjMgrEnumVisibleObjects)(void *fun, int filter);
...
#define ClntObjMgrEnumVisibleObjects ((FnClntObjMgrEnumVisibleObjects)OFFSET_CLNTOBJMGRENUMVISIBLEOBJECTS)